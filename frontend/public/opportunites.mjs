  ...
  keys.forEach(key => {
    ...
    container.innerHTML = `
      <div class="product">
        ...
        <p class="product-p2" name="stipend">stipend:  $${opportunity.stipend} /month</p>
        <p class="product-p2" name="duration">duration: ${opportunity.duration} months </p>
        <p class="product-p2" name="mode">work-mode: ${opportunity.mode} </p>
        <p class="product-p2" name="type">work-type: ${opportunity.type} </p>
        <div class="product-buttons">
          <button class="product-button-add" type="button" onclick="window.open('${opportunity.link}', '_blank')">Apply Now</button>
